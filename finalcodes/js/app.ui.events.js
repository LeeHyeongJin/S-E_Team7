...
/*global window, $, tizen, app, tau */

/**
 * UiEvents class constructor.
 *
 * @public
 * @constructor
 * @param {Ui} parent
...
//            });
            ...
            $('#ui-myPowerOn').on('click', function onMySendClick(event) {
                event.stopPropagation();
                var message = "PowerON"
...
//                self.ui.disableSendButton();
            ...
            $('#ui-myPowerOff').on('click', function onMySendClick(event) {
                event.stopPropagation();
                var message = "PowerOFF"
...
//                self.ui.disableSendButton();
            ...
            $('#ui-myCurrentState').on('click', function onMySendClick(event) {
                event.stopPropagation();
                var message = "current"
...
//                self.ui.disableSendButton();
            ...
            $('#ui-myHot').on('click', function onMySendClick(event) {
                event.stopPropagation();
                var message = "tUP"
...
//                self.ui.disableSendButton();
            ...
            $('#ui-myCold').on('click', function onMySendClick(event) {
                event.stopPropagation();
                var message = "tDOWN"
...
//                self.ui.disableSendButton();
            ...
            $('#ui-myHum').on('click', function onMySendClick(event) {
                event.stopPropagation();
                var message = "Humi"
...
//                self.ui.disableSendButton();
            ...
            $('#ui-myStat').on('click', function onMySendClick(event) {
                event.stopPropagation();
                var message = "statistic"
...
//                self.ui.disableSendButton();
                ...
                //////
                	...
                	console.log("statatatatatttattata");
                	var xmlHttp = new XMLHttpRequest();
                	xmlHttp.open("GET", "http://52.78.205.229//show-stat.php", true); // true for asynchronous
                	xmlHttp.onreadystatechange = function() { 
                        if (xmlHttp.readyState == 4 && xmlHttp.status == 200){
                        	app.ui.displayReceivedMessage(""+xmlHttp.responseText);
                        }
            ...
            window.addEventListener('tizenhwkey',
                function onTizenHardwareKey(e) {
                    if (e.keyName === 'back') {
                        e.preventDefault();
                        app.setDoNotSendBye(true);
                        if (tau.activePage.id === 'start') {
                            tizen.application.getCurrentApplication().exit();
                        } else if (tau.activePage.id === 'chat') {
                            tau.changePage('#start');
                        } else {
                            window.history.back();
                        }
